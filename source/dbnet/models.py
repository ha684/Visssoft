...
from source.dbnet.modules.resnet import resnet18, resnet50, deformable_resnet18, deformable_resnet50
from source.dbnet.modules.segmentation_head import DBHead
from source.dbnet.modules.segmentation_body import FPN, FPEM_FFM, FPEM, _FPN
# resnet18 64, 128, 256, 512
backbone_dict = {'resnet18': {'models': resnet18, 'out': [64, 128, 256, 512]}}
segmentation_body_dict = {'FPN': _FPN}
